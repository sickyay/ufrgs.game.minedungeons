...
int main(void)
{
    ...
    textures[16] = LoadTexture("resources/textures/hearthud.png");
    textures[17] = LoadTexture("resources/textures/yellowhearthud.png");
    textures[18] = LoadTexture("resources/textures/blackhearthud.png");
