...
#define ENEMY1_ACTION_COOLDOWN 1

//creeper
#define ENEMY2_STEP_COOLDOWN 0.3
#define ENEMY2_ACTION_COOLDOWN 0.5

//slime
#define ENEMY3_STEP_COOLDOWN 0.3
#define ENEMY3_ACTION_COOLDOWN 0.5
...
bool draw_map (struct STRUCT_DATA *data, Texture2D texture[])//funcao que le o que acontece na matriz do mapa
{
    ...
    for (int y = 0; y < MAP_LINES; y++)//colunas
    {
        for (int x = 0; x < MAP_COLUMNS; x++)//linhas
        {
            ...
            case 'C'://inimigo
                DrawTexture(texture[9],x*SIDE,y*SIDE,WHITE);
                break;
    ...
    for (int y = 0; y < MAP_LINES; y++)//colunas
    {
        for (int x = 0; x < MAP_COLUMNS; x++)//linhas
        {
            ...
            case 'E'://inimigo ESQUELETO
                ...
                data->enemy1[data->enemy1_counter].health_points = 5;
            ...
            case 'C'://inimigo CREEPER
                ...
                data->enemy2[data->enemy2_counter].health_points = 5;
            ...
            case 'S'://inimigo SLIME
                ...
                data->enemy3[data->enemy3_counter].health_points = 5;
...
int main(void)
{
    ...
    while (!WindowShouldClose()){//Roda enquanto não for fechada a tela
        ...
        if (!menu_open) //Roda enquanto o menu não for aberto
        {
            ...
            {
                if(data.enemy[i].health_points>0) enemies_alive++;
            }
