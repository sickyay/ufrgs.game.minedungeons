...
int scan_map (char matrix[MAP_LINES][MAP_COLUMNS+1],struct STRUCT_STATS *player_variable, struct STRUCT_STATS enemy_vector[], struct STRUCT_STATS projectile_vector[], struct STRUCT_STATS wall_vector[])//funcao que le o que acontece na matriz do mapa
{
    int wall_counter = 0, enemy_counter = 0, bomb_counter = 0, portal_counter = 0, campfire_counter = 0, projectile_counter = 0;
...
int main(void)
{
    ...
    struct STRUCT_STATS player = {0,0,0,0,0,0,0,PLAYER_STEP_COOLDOWN,0,10,0};
    ...
    scan_map(map,&player,enemy,projectile,wall);
